  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState3 = React13.useState, useEffect6 = React13.useEffect, useLayoutEffect5 = React13.useLayoutEffect, useDebugValue = React13.useDebugValue;
...
function Matches() {
  ...
  const inner = (0, import_jsx_runtime3.jsx)(matchContext.Provider, { value: matchId, children: (0, import_jsx_runtime3.jsx)(
    CatchBoundary,
    {
      getResetKey: () => resetKey,
...
function RouterContextProvider({
  ...
  const provider = (
    ...
    (0, import_jsx_runtime4.jsxs)(routerContext2.Provider, { value: router, children: [
      children,
...
function Transitioner() {
  ...
  const [isTransitioning, startReactTransition_] = React7.useTransition();
    ...
    this.buildLocation = (opts) => {
      const build = (dest = {}, matches) => {
        ...
        let pathname = dest.to ? this.resolvePathWithBase(fromPath, `${dest.to}`) : this.resolvePathWithBase(
          fromPath,
          ((_c = stayingMatches == null ? void 0 : stayingMatches.find((d) => d.pathname === fromPath)) == null ? void 0 : _c.routeId) || fromPath
        );
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FSAIEPVZ.js.map
